<template>
  <div class="supplier_management">
    <header class="top-head">
      <el-button type="primary" size="small" @click="multiExport">批量导出</el-button>
      <el-button type="primary" size="small" @click="deleteSaleBtn">删除</el-button>
      <el-button type="primary" size="small" @click="cancelInterceptOrderBtn">取消拦截</el-button>
  ...
  export default {
    ...
    methods: {
      ...
      async getMainList(params) {
        ...
        const { data } = await this.$ajaxPost('wms/saleoutAbnormal/selectPage.do', {
        ...
        if (data.code === 200) {
          ...
          if (this.tableData.length !== 0) {
            ...
            this.loadingTable.inventory = false;
             //搜索为空时  清空商品明细，订单明细，备注/留言，发票信息，操作记录
      ...
      multiExport() {
        this.$refs.exportFile.export('异常单管理','/saleoutAbnormal/export.do',{},this.searchData)         
      },
    },
  }
</script>
